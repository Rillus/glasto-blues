...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create glasto-blues-1970
  fly apps create glasto-blues-1970-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app glasto-blues-1970
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app glasto-blues-1970-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'glasto-blues-1970-staging' does not match app name in config file 'glasto-blues-1970'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name glasto-blues-1970-db
  fly postgres attach --app glasto-blues-1970 glasto-blues-1970-db

  fly postgres create --name glasto-blues-1970-staging-db
  fly postgres attach --app glasto-blues-1970-staging glasto-blues-1970-staging-db
  ```
